...
def provision_user(sf_url, credentials, user_data):
    auth_cookie = {'auth_pubtkt': get_cookie(sf_url, *credentials)}
    return requests.post(sf_url + "manage/services_users/",
                         json=user_data,
                         cookies=auth_cookie)
